...
\hline
\endlastfoot
\textbf{0.13} & 09/03/26 & Mattia Oliva Medin & Programmatore & Sara Gioia Fichera & Aggiunta pianificazione nono periodo \\
\hline
        ...
        \subsubsection{Riferimenti informativi}
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    \item[] (Ultimo accesso: 10/01/2026)
                \end{itemize}
        ...
        \subsubsection{26/01/2026 - 08/02/2026 - Settimo periodo}
            ...
            \paragraph{Consuntivo}
                ...
                \hline
                    Zaghetto & & & 5 & & & & 5\\
                \hline
                    \rowcolor{lightgray}\textit{Totale per ruolo} & 10 & 6 & 5 & 0 & 22 & 8 & 51\\
                \hline
                    \rowcolor{lightgray}\textit{Totale costi} & 300 & 120 & 125 & 0 & 330 & 120 & 995\\
                \hline
                \end{tabular}
                \end{table}
            ...
            \paragraph{Consuntivo}
                \begin{table}[H]
                \centering
                \caption{Consuntivo orario settimo periodo}
                \begin{tabular}{|l|c|c|c|c|c|c|c|}
                \hline
                    \rowcolor{lightgray}{\textbf{Membro}} & {\textbf{RE}} & {\textbf{AM}} & {\textbf{AN}} & {\textbf{PRJ}} & {\textbf{PRG}} & {\textbf{VER}} & {\textbf{TOTALE}}\\
                \hline
                ...
                \centering
                \begin{tikzpicture}
                \pie [polar, explode=0.1, text=legend] { 19.61/Responsabile, 11.76/Amministratore, 9.80/Analista, 43.14/Programmatore, 15.69/Verificatore }
                \end{tikzpicture}
                \caption{Consuntivo orario in percentuale - Settimo periodo}
                \end{figure}
            ...
            \paragraph{Risorse rimanenti}
                ...
                \hline
                    Verificatore & 8 & 120\\
                \hline
                    \rowcolor{lightgray}\textit{Totale} & 51 & 995\\
                \hline
                    \rowcolor{lightgray}\textit{Rimanenti} & 319 & 6275\\
                \hline
                \end{tabular}
                \end{table}
        ...
        \subsubsection{09/02/2026 - 22/02/2026 - Ottavo periodo}
            ...
            \paragraph{Consuntivo}
                ...
                \hline
                    Zaghetto & 3 & & & & & 6 & 9\\
                \hline
                    \rowcolor{lightgray}\textit{Totale per ruolo} & 3 & 4 & 4 & 0 & 33 & 12 & 56\\
                \hline
                    \rowcolor{lightgray}\textit{Totale costi} & 90 & 80 & 100 & 0 & 495 & 180 & 945\\
                \hline
                \end{tabular}
                \end{table}
                ...
                \centering
                \begin{tikzpicture}
                \pie [polar, explode=0.1, text=legend] { 5.35/Responsabile, 7.14/Amministratore, 7.14/Analista, 58.93/Programmatore, 21.44/Verificatore }
                \end{tikzpicture}
            ...
            \paragraph{Risorse rimanenti}
                ...
                \hline
                    Verificatore & 12 & 180\\
                \hline
                    \rowcolor{lightgray}\textit{Totale} & 56 & 945\\
                \hline
                    \rowcolor{lightgray}\textit{Rimanenti} & 263 & 5330\\
                \hline
                \end{tabular}
                \end{table}
        ...
        \subsubsection{23/02/2026 - 08/03/2026 - Nono periodo}
            ...
            \paragraph{Consuntivo}
                ...
                \hline
                    Zaghetto & & & & 11 & & & 11\\
                \hline
                    \rowcolor{lightgray}\textit{Totale per ruolo} & 3 & 4 & 0 & 34 & 25 & 8 & 74\\
                \hline
                    \rowcolor{lightgray}\textit{Totale costi} & 90 & 80 & 0 & 850 & 375 & 120 & 1515\\
                \hline
                \end{tabular}
                \end{table}
                ...
                \centering
                \begin{tikzpicture}
                \pie [polar, explode=0.1, text=legend] { 4.05/Responsabile, 5.41/Amministratore, 45.95/Progettista, 33.78/Programmatore, 10.81/Verificatore }
                \end{tikzpicture}
            ...
            \paragraph{Risorse rimanenti}
                ...
                \hline
                    Verificatore & 8 & 120\\
                \hline
                    \rowcolor{lightgray}\textit{Totale} & 74 & 1515\\
                \hline
                    \rowcolor{lightgray}\textit{Rimanenti} & 189 & 3815\\
                \hline
                \end{tabular}
                \end{table}
