...
\begin{document}
    ...
    La presente sezione definisce gli obiettivi di qualità del progetto, specificando per ciascuna metrica definita all'interno della sezione 5 del documento di Norme di Progetto v1.0 i range di accettazione e i valori ideali prefissati dal gruppo. La classificazione segue la distinzione tra:
    \begin{itemize}
...
\newpage
    ...
    L'attività di testing è concepita come un processo continuo e fondamentale per rilevare tempestivamente eventuali difetti, assicurando che il sistema soddisfi tutti i requisiti concordati.
        ...
        Questi test fanno riferimento ai requisiti riportati nella sezione 4 del documento di Analisi dei Requisiti v1.0.
