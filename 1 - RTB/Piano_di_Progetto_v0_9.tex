...
\hline
\textbf{0.10} & 26/01/26 & Mattia Oliva Medin & Progettista & Filippo Compagno & Aggiunta pianificazione sesto periodo \\
\hline
    ...
    % SESTO PERIODO --------------------------
        \subsubsection{12/01/2026 - 25/01/2026 - Sesto periodo}
            ...
            I ruoli assegnati per il secondo periodo sono i seguenti:
                ...
                \hline
                    Progettista & \makecell[l]{Filippo Compagno \\ Bianca Zaghetto} \\
                \hline
                    Programmatore & \makecell[l]{Francesco Balestro \\ Andrea Masiero} \\
                \hline
                    Verificatore & \makecell[l]{Sara Gioia Fichera \\ Mattia Oliva Medin \\ Nenad Radulovic} \\
                \hline
                \end{tabular}
            ...
            \paragraph{Preventivo}
                ...
                \hline
                    Zaghetto & & & & & & 9 & 9\\
                \hline
                    \rowcolor{lightgray}\textit{Totale per ruolo} & 5 & 8 & 4 & 16 & 9 & 20 & 62\\
                \hline
                    \rowcolor{lightgray}\textit{Totale costi} & 150 & 160 & 100 & 400 & 135 & 300 & 1245\\
                \hline
                \end{tabular}
                ...
                \centering
                \begin{tikzpicture}
                \pie [polar, explode=0.1, text=legend] { 8.07/Responsabile, 12.90/Amministratore, 6.45/Analista, 25.80/Progettista, 14.52/Programmatore, 32.26/Verificatore }
                \end{tikzpicture}
            ...
            \paragraph{Consuntivo}
                ...
                \hline
                    Zaghetto & & & & & & 12 & 12\\
                \hline
                    \rowcolor{lightgray}\textit{Totale per ruolo} & 6 & 9 & 8 & 21 & 12 & 25 & 81\\
                \hline
                    \rowcolor{lightgray}\textit{Totale costi} & 180 & 180 & 200 & 525 & 180 & 375 & 1640\\
                \hline
                \end{tabular}
                ...
                \centering
                \begin{tikzpicture}
                \pie [polar, explode=0.1, text=legend] { 7.41/Responsabile, 11.11/Amministratore, 9.88/Analista, 25.93/Progettista, 14.81/Programmatore, 30.86/Verificatore }
                \end{tikzpicture}
            ...
            \paragraph{Risorse rimanenti}
                ...
                \hline
                    Verificatore & 25 & 375\\
                \hline
                    \rowcolor{lightgray}\textit{Totale} & 81 & 1640\\
                \hline
                    \rowcolor{lightgray}\textit{Rimanenti} & 339 & 6565\\
                \hline
                \end{tabular}
                \caption{Risorse economiche rimanenti dal consuntivo orario}
                \end{table}
