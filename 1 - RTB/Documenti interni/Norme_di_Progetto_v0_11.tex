...
\section{Processi Primari}
    ...
    \subsection{Sviluppo}
        ...
        \subsubsection{Analisi dei requisiti}
            L'analisi dei requisiti è un'attività fondamentale del processo di sviluppo e tra le più importanti entro la prima prime baseline del progetto (\textbf{RTB}).
            Il suo scopo è quello trasformare le richieste e le esigenze espresse dalla proponente in requisiti chiari, completi e verificabili che coprono tutti le funzionalità e i vincoli che il progetto dovrà soddisfare.\\
            ...
            \paragraph{Analisi dinamica}
                ...
                \begin{itemize}
                    ...
                    \item \textbf{Test di regressione}\\
                        I test di regressione accertano che i cambiamenti appartati a delle unità non danneggino il resto del sistema.\\
...
\section{Processi Organizzativi}
    \subsection{Gestione dei Processi}
        ...
        \subsubsection{Ruoli di progetto}
            ...
            Ogni ruolo ha una funzioni ben definite riguardanti specifiche attività ed è necessario per il raggiungimento degli obiettivi finali.
