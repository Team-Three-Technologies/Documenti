...
\setTitle{Glossario}
\setAuthors{Filippo Compagno \\ & Mattia Oliva Medin \\ & Sara Gioia Fichera}
        ...
        \section*{C} {
            \begin{itemize}
                \item \textbf{Capitolato}\\
                    Documento redatto dal committente di un'appalto o di un progetto in cui vengono fissate le aspettattive, le specifiche, i requisiti e i vincoli sul prodotto da realizzare.
                \item \textbf{Caso d'uso}\\
                    Insieme di scenari, cioè una sequenza di azioni, che hanno in comune uno scopo finale (obiettivo) per un utente (attore). In altre parole è una situazione nella quale il sistema viene utiizzato per soddisfare i bisogni dell'utente.
