    ...
    L'attività di testing è concepita come un processo continuo e fondamentale per rilevare tempestivamente eventuali difetti, assicurando che il sistema soddisfi tutti i requisiti concordati.
        ...
        Questi test fanno riferimento ai requisiti riportati nel documento di \textit{Analisi dei Requisiti} (\S4).
            ...
            \begin{longtable}{|M{1.2cm}|M{6.3cm}|M{2.5cm}|M{1.5cm}|}
                ...
                TS71 & Verificare che il sistema mostri un messaggio di errore se l'esportazione fallisce & R71-F-Ob & NI \\
                \hline
                ...
                TS74 & Verificare che il sistema permetta la stampa di un documento selezionato & R74-F-Op & NI \\
                \hline

                TS75 & Verificare che il sistema mostri un messaggio di errore se la stampa fallisce & R75-F-Ob & NI \\
                \hline
                                
                TS76 & Verificare che l'utente possa verificare la firma digitale di un documento selezionato & R76-F-Op & NI \\
                \hline

                TS77 & Verificare che l'utente veda il risultato a seguito della verifica della firma digitale & R77-F-Op & NI \\
                \hline
