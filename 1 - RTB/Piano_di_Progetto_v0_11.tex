...
\label{sec:pianificazione}
    ...
    % SETTIMO PERIODO --------------------------
        \subsubsection{26/01/2026 - 08/02/2026 - Settimo periodo}
            \paragraph{Panoramica e obiettivi}
            Il settimo periodo è stato caratterizzato dal completamento dei vari documenti e del PoC per poi effettuare la candidatura RTB. Gli obiettivi sono stati:
            \begin{itemize}
