...
\begin{document}
    ...
    \begin{table}[h!]
        ...
        \begin{tabularx}{\textwidth}{|l|l|l|l|X|X|}
            ...
            \hline
            \textbf{0.2} & 15/11/2025 & Francesco Balestro & Verificatore &  & Correzione errori \\
            \hline
            \textbf{0.1} & 14/11/2025 & Francesco Balestro & Verificatore & Bianca Zaghetto & Prima stesura \\
        \hline
        \end{tabularx}
    \end{table}
