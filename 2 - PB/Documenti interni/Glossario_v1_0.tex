    ...
    \include{docTitlepage}
        ...
        \begin{table}[h!]
            ...
            \begin{tabularx}{\textwidth}{|l|l|l|l|L|L|}
                ...
                \hline
                \textbf{1.0} & 26/04/2026 & Francesco Balestro & Responsabile &  & Approvazione documento\\
                \hline
                \textbf{0.6} & 17/04/2026 & Sara Gioia Fichera & Amministratore & Francesco Balestro & Aggiunta termini relativi al Manuale Utente\\
                \hline
        ...
        \section*{A} {
            \begin{itemize}
                ...
                \item \textbf{AIP}\\
                    Acronimo di Archival Information Package. Rappresenta il pacchetto informativo che viene memorizzato e preservato a lungo termine all'interno del sistema di conservazione.
                ...
                \item \textbf{Angular}\\
                    Framework open-source sviluppato da Google in linguaggio TypeScript, utilizzato per lo sviluppo di applicazioni web.
                ...
                \item \textbf{AOO}\\
                    Acronimo di Area Organizzativa Omogenea, rappresenta il raggruppamento di unità della Pubbliche Amministrazioni che fanno ricorso allo stesso servizio per il protocollo informatico.
                \item \textbf{AppImage}\\
                    Formato universale per la distribuzione di software su sistemi Linux. Consente di eseguire un'applicazione tramite un singolo file, senza necessità di installazione.
                \item \textbf{Archivio}\\
        ...
        \section*{F} {
            \begin{itemize}
                \item \textbf{File}\\
                    Insieme di informazioni, dati o comandi logicamente correlati, raccolti sotto un unico nome e registrati, per mezzo di un programma di elaborazione o di scrittura, nella memoria di un computer.
                \item \textbf{Fornitore}\\
                    Soggetto che progetta, sviluppa e consegna il software richiesto.
                \item \textbf{Firma digitale}\\
                    Equivalente informatico di una firma autografa su carta, che attribuisce pieno valore legale ai documenti elettronici e garantisce l'autenticità del firmatario.
                \item \textbf{Framework}\\
                    Architettura logica di supporto per lo sviluppo software. Fornisce componenti riutilizzabili, librerie e regole architetturali.
            \end{itemize}
        }
        \addcontentsline{toc}{section}{\numberline{}F}
        \newpage
        ...
        \section*{I} {
            \begin{itemize}
                ...
                \item \textbf{IPA}\\
                    Acronimo di Indice delle Pubbliche Amministrazioni. Identifica, tramite un codice alfanumerico di 6 cifre, l'ufficio destinatario della fattura elettronica o il domicilio digitale dell'ente.                \end{itemize}            
        }
        \addcontentsline{toc}{section}{\numberline{}I}
        \newpage
        ...
        \section*{P} {
            \begin{itemize}
                ...
                \item \textbf{Portable}\\
                    Tipologia di software progettato per essere eseguito direttamente, senza alcun tipo di installazione sul sistema operativo.
                \item \textbf{Prettier}\\
                    Strumento per la formattazione automatica del codice sorgente. Supporta molteplici linguaggi e garantisce uno stile visivo uniforme per tutto il progetto secondo regole predefinite.
        ...
        \section*{U} {
            \begin{itemize}
                ...
                \item \textbf{UOR}\\
                    Il codice UOR (Unità Organizzativa Responsabile) è un identificativo univoco assegnato a specifici uffici o aree di un'amministrazione pubblica responsabili della gestione dei documenti e dei procedimenti amministrativi. 
            \end{itemize}
        }
        \addcontentsline{toc}{section}{\numberline{}U}
        \newpage
