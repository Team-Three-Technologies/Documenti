...
\setAuthors{Bianca Zaghetto \\ & Mattia Oliva Medin \\ & Sara Gioia Fichera \\ & Nenad Radulovic \\ & Filippo Compagno}
        ...
        \subsubsection{23/03/2026 - 29/03/2026 - Undicesimo periodo}
            ...
            \paragraph{Consuntivo}
                ...
                \hline
                    Zaghetto & & & & 6 & & 2 & 8\\
                \hline
                    \rowcolor{lightgray}\textit{Totale per ruolo} & 2 & 2 & 0 & 33 & 16 & 2 & 55\\
                \hline
                    \rowcolor{lightgray}\textit{Totale costi} & 60 & 40 & 0 & 825 & 240 & 30 & 1195\\
                \hline
                \end{tabular}
                \end{table}
                ...
                \centering
                \begin{tikzpicture}
                \pie [polar, explode=0.1, text=legend] { 3.63/Responsabile, 3.63/Amministratore, 60/Progettista, 29.09/Programmatore, 3.63/Verificatore }
                \end{tikzpicture}
            ...
            \paragraph{Risorse rimanenti}
                ...
                \hline
                    Verificatore & 2 & 30\\
                \hline
                    \rowcolor{lightgray}\textit{Totale} & 55 & 1195\\
                \hline
                    \rowcolor{lightgray}\textit{Rimanenti} & 150 & 2725\\
                \hline
                \end{tabular}
                \end{table}
        ...
        \subsubsection{30/03/2026 - 05/04/2026 - Dodicesimo periodo}
            ...
            \paragraph{Consuntivo}
                ...
                \hline
                    Zaghetto & & & & & 5 & 2 & 7\\
                \hline
                    \rowcolor{lightgray}\textit{Totale per ruolo} & 2 & 2 & 0 & 15 & 23 & 12 & 54\\
                \hline
                    \rowcolor{lightgray}\textit{Totale costi} & 60 & 40 & 0 & 375 & 345 & 180 & 1000\\
                \hline
                \end{tabular}
                \end{table}
                ...
                \centering
                \begin{tikzpicture}
                \pie [polar, explode=0.1, text=legend] { 3.70/Responsabile, 3.70/Amministratore, 27.78/Progettista, 42.59/Programmatore, 22.22/Verificatore }
                \end{tikzpicture}
            ...
            \paragraph{Risorse rimanenti}
                ...
                \hline
                    Verificatore & 12 & 180\\
                \hline
                    \rowcolor{lightgray}\textit{Totale} & 54 & 1000\\
                \hline
                    \rowcolor{lightgray}\textit{Rimanenti} & 96 & 1725\\
                \hline
                \end{tabular}
                \end{table}
        ...
        \subsubsection{06/04/2026 - 12/04/2026 - Tredicesimo periodo}
            ...
            \paragraph{Consuntivo}
                ...
                \hline
                    Zaghetto & & 2 & & & 6 & & 8\\
                \hline
                    \rowcolor{lightgray}\textit{Totale per ruolo} & 2 & 2 & 0 & 12 & 24 & 10 & 50\\
                \hline
                    \rowcolor{lightgray}\textit{Totale costi} & 60 & 40 & 0 & 300 & 360 & 150 & 910\\
                \hline
                \end{tabular}
                \end{table}
                ...
                \centering
                \begin{tikzpicture}
                \pie [polar, explode=0.1, text=legend] { 4/Responsabile, 4/Amministratore, 24/Progettista, 48/Programmatore, 20/Verificatore }
                \end{tikzpicture}
            ...
            \paragraph{Risorse rimanenti}
                ...
                \hline
                    Verificatore & 10 & 150\\
                \hline
                    \rowcolor{lightgray}\textit{Totale} & 50 & 910\\
                \hline
                    \rowcolor{lightgray}\textit{Rimanenti} & 46 & 815\\
                \hline
                \end{tabular}
                \end{table}
