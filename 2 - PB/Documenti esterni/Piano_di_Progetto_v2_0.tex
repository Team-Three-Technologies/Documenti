...
\hline
\endlastfoot
\textbf{2.0} & 28/04/26 & Bianca Zaghetto & Responsabile & - & Approvazione e rilascio \\
\hline
\textbf{1.7} & 28/04/26 & Mattia Oliva Medin & Programmatore & Nenad Radulovic & Aggiunto riassunto risorse utilizzate \\
\hline
\textbf{1.6} & 27/04/26 & Mattia Oliva Medin & Programmatore & Nenad Radulovic & Aggiunta pianificazione quindicesimo periodo \\
\hline
...
% TREDICESIMO PERIODO --------------------------
    ...
    % QUINDICESIMO PERIODO --------------------------
        \subsubsection{20/04/2026 - 26/04/2026 - Quindicesimo periodo}
            \paragraph{Panoramica e obiettivi}
            Il quindicesimo periodo è stato caratterrizato dal termine della condifica, l'effettuazione dei test e il termine della stesura dei vari documenti. Gli obiettivi sono stati:
            \begin{itemize}
                \item Terminare codifica
                \item Terminare Piano di Qualifica
                \item Terminare Piano di Progetto
                \item Terminare stesura Specifica Tecnica
                \item Terminare stesura Manuale Utente
            \end{itemize}
            ...
            \paragraph{Gestione rischi}
                ...
                \item\hyperref[tab:r1]{[R1-1] Inesperienza nelle tecnologie da utilizzare}
                \end{itemize}
                Dato il proseguimento della codifica e l'effettuazione dei test, il gruppo ha previsto l'incorrere di rischi riguardanti l'inesperienza nelle tecnologie.
    
                \paragraph*{Rischi incontrati}
                Durante questo periodo il gruppo non ha riscontrato alcun rischio ed è riuscito a terminare tutti i lavori rispettando i tempi previsti.
                
            \paragraph{Ruoli assegnati}
            I ruoli assegnati per il quindicesimo periodo sono i seguenti:
                \begin{table}[H]
                \centering
                \caption{Ruoli quindicesimo periodo}
                \begin{tabular}{|l|l|}
                \hline
                    \rowcolor{lightgray}{\textbf{Ruolo}} & {\textbf{Membro}} \\
                \hline
                ...
                \hline
                    Progettista & - \\
                \hline
                    Programmatore & \makecell[l]{ Filippo Compagno \\ Sara Gioia Fichera \\ Mattia Oliva Medin } \\
                \hline
                    Verificatore & \makecell[l]{ Nenad Radulovic \\ Bianca Zaghetto } \\
                \hline
                \end{tabular}
                \end{table}
            ...
            \paragraph{Preventivo}
                \begin{table}[H]
                \centering
                \caption{Preventivo orario quindicesimo periodo}
                \begin{tabular}{|l|c|c|c|c|c|c|c|}
                \hline
                    \rowcolor{lightgray}{\textbf{Membro}} & {\textbf{RE}} & {\textbf{AM}} & {\textbf{AN}} & {\textbf{PRJ}} & {\textbf{PRG}} & {\textbf{VER}} & {\textbf{TOTALE}}\\
                \hline
                ...
                \hline
                    Zaghetto & & & & & & 6 & 6\\
                \hline
                    \rowcolor{lightgray}\textit{Totale per ruolo} & 4 & 4 & 0 & 0 & 18 & 12 & 38\\
                \hline
                    \rowcolor{lightgray}\textit{Totale costi} & 120 & 80 & 0 & 0 & 270 & 180 & 650\\
                \hline
                \end{tabular}
                \end{table}
                ...
                \centering
                \begin{tikzpicture}
                \pie [polar, explode=0.1, text=legend] { 10.53/Responsabile, 10.53/Amministratore,  47.37/Programmatore, 31.58/Verificatore }
                \end{tikzpicture}
                \caption{Preventivo orario in percentuale - Quindicesimo periodo}
                \end{figure}
                
            \paragraph{Consuntivo}
                \begin{table}[H]
                \centering
                \caption{Consuntivo orario quindicesimo periodo}
                \begin{tabular}{|l|c|c|c|c|c|c|c|}
                \hline
                    \rowcolor{lightgray}{\textbf{Membro}} & {\textbf{RE}} & {\textbf{AM}} & {\textbf{AN}} & {\textbf{PRJ}} & {\textbf{PRG}} & {\textbf{VER}} & {\textbf{TOTALE}}\\
                \hline
                ...
                \hline
                    Zaghetto & & & & & 2 & 3 & 5\\
                \hline
                    \rowcolor{lightgray}\textit{Totale per ruolo} & 2 & 2 & 0 & 0 & 15 & 17 & 36\\
                \hline
                    \rowcolor{lightgray}\textit{Totale costi} & 60 & 40 & 0 & 0 & 225 & 255 & 580\\
                \hline
                \end{tabular}
                \end{table}
                ...
                \centering
                \begin{tikzpicture}
                \pie [polar, explode=0.1, text=legend] { 5.56/Responsabile, 5.56/Amministratore, 41.67/Programmatore, 47.22/Verificatore }
                \end{tikzpicture}
                \caption{Consuntivo orario in percentuale - Quindicesimo periodo}
                \end{figure}
            ...
            \paragraph{Risorse rimanenti}
                ...
                \hline
                    Verificatore & 17 & 255\\
                \hline
                    \rowcolor{lightgray}\textit{Totale} & 36 & 580\\
                \hline
                    \rowcolor{lightgray}\textit{Rimanenti} & 4 & 185\\
                \hline
                \end{tabular}
                \end{table}
                
            \paragraph{Retrospettiva}
            Questo periodo è stato caratterizzato dal termine del progetto didattico. Durante questo sprint i membri del gruppo si sono impegnati al massimo per terminare tutto il lavoro preventivato, obiettivo che è stato raggiunto con successo.
            Il gruppo effettuerà un incontro con la proponente per effettuare l'approvazione MVP ed in seguito è pronto ad affrontare la fase finale della Product Baseline.

\section{Riassunto risorse utilizzate}
                \begin{table}[H]
                \centering
                \caption{Risorse utilizzate}
                \begin{tabular}{|l|c|c|c|c|c|c|c|}
                \hline
                    \rowcolor{lightgray}{\textbf{Membro}} & {\textbf{RE}} & {\textbf{AM}} & {\textbf{AN}} & {\textbf{PRJ}} & {\textbf{PRG}} & {\textbf{VER}} & {\textbf{TOTALE}}\\
                \hline
                    Balestro & 10 & 11 & 12 & 11 & 23 & 24 & 91\\
                \hline
                    Compagno & 11 & 10 & 16 & 17 & 18 & 20 & 92\\
                \hline
                    Fichera & 8 & 8 & 11 & 14 & 26 & 25 & 92\\
                \hline
                    Masiero & 12 & 8 & 10 & 14 & 19 & 28 & 91\\
                \hline
                    Oliva Medin & 8 & 11 & 11 & 16 & 25 & 20 & 91\\
                \hline
                    Radulovic & 11 & 12 & 10 & 13 & 29 & 17 & 92\\
                \hline
                    Zaghetto & 12 & 11 & 11 & 10 & 21 & 26 & 91\\
                \hline
                    \rowcolor{lightgray}\textit{Totale per ruolo} & 72 & 71 & 81 & 95 & 161 & 160 & 640\\
                \hline
                    \rowcolor{lightgray}\textit{Totale costi} & 2160 & 1420 & 2025 & 2375 & 2415 & 2400 & 12795\\
                \hline
                \end{tabular}
                \end{table}
                ...
                \centering
                \begin{tikzpicture}
                \pie [polar, explode=0.1, text=legend] { 11.25/Responsabile, 11.09/Amministratore, 12.66/Analista, 14.84/Progettista, 25.16/Programmatore, 25/Verificatore }
                \end{tikzpicture}
                \caption{Consuntivo orario in percentuale - Totale risorse utilizzate}
                \end{figure}

                \subsection{Retrospettiva Finale}
                Il progetto è stato terminato con un costo totale di \textbf{12795€}, con un totale di \textbf{640} ore lavorate. Il costo rispetta il budget iniziale previsto di \textbf{12980€} restando con un saldo rimanente di \textbf{185€}.
                Dalla tabella si mostra inoltre che tutti i componenti del gruppo hanno lavorato in modo abbastanza equo, con un totale di ore lavorate di poco inferiore alle ore totali previste di \textbf{644}.
