    ...
    \section{Architettura} {
        ...
        \subsection{Architettura dei processi e comunicazione} {
            ...
            \subsubsection{Main process} {
                ...
                \begin{itemize}
                    \item \textbf{DTO (Data Transfer Objects)}: oggetti per il trasporto dei dati tra i layer, che si trovano nella cartella \verb|shared/|, unico parte di codice condiviso tra i due processi (Sezione \ref{sec:DTO});
