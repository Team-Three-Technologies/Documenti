...
\setAuthors{Sara Gioia Fichera \\ & Andrea Masiero}
\setVerificators{Nenad Radulovic \\ & Francesco Balestro}
\setApprovation{}
\setVersion{0.3}
\setType{Esterno}
...
\begin{document}
    ...
    \section{Installazione}
        ...
        DIPReader è un'applicazione desktop autonoma che non richiede l'installazione di componenti aggiuntive. Tutto il necessario per il funzionamento è già incluso nel pacchetto di distribuzione. \\
        ...
        \subsection{Installazione}
            Per installare l'applicativo DIPReader la procedura cambia leggermente in base al sistema operativo in uso. In nessun caso è richiesta l'installazione di componenti aggiuntive.

            (procedura con screen di come fare il download dalla repo. ??)

            \begin{itemize}
                \item Windows: Il pacchetto è un file eseguibile .exe di tipo portable. È sufficiente scaricare il file, posizionarlo nella cartella desiderata e avviarlo con un doppio clic.
                \item macOS: Il pacchetto per macOS è distribuito come archivio .zip. \\
                    ...
                    \begin{enumerate}
                        ...
                        \item Trascinare l'applicazione nella cartella scelta
                ...
                \item Linux: Il pacchetto è distribuito nel formato AppImage, un formato universale compatibile con la maggior parte delle distribuzioni Linux. \\
                    ...
                    \begin{enumerate}
                        ...
                        \item Renderlo eseguibile: tasto destro sul file $\rightarrow$ Proprietà $\rightarrow$ spuntare "Consenti esecuzione come programma" (oppure da terminale con il comando chmod + x nomeFile.AppImage ??)
                        \item Avviare l'applicazione con un doppio clic
                    \end{enumerate}
                    Non è necessario disporre di permessi di amministratore.
            \end{itemize}

        \subsection{Primo avvio}
            Una volta avviato DIPReader, l'applicazione si apre direttamente sull'interfaccia principale, senza richiedere alcuna registrazione, creazione di account o configurazione. Se l'eseguibile non è stato posizionato all'interno di una cartella DIP valida, la lista dei documenti risulta vuota.
            Per caricare un pacchetto DIP e iniziare la consultazione, fare riferimento alla sezione \ref{sec:apertura}.
    ...
    \section{Guida all'utilizzo}
        ...
        \subsection{Ricerca e uso dei filtri}
            ...
            \begin{figure}[h!]
                ...
                \caption{Impostare più filtri contemporaneamente}
                \label{fig:filter2}
            \end{figure}
        ...
        Il riquadro "Informazioni del pacchetto (DIP)", sempre visibile in basso a sinistra, riporta: data di creazione, nome e versione del programma usato per generarlo, produttore e numero totale di documenti contenuti.
